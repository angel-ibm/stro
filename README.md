...
- finally, we have an embedding which is inserted into a collection in Milvus. Indeed, we can consider it like a vector whose components (or coordinates) are the intensitiy values of each pixel (normalized). Yeah: we are moving us in a space of 11600 dimensions!
